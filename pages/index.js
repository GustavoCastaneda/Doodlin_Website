...
export default function Home() {
  return (
    <div className="min-h-screen h-full w-full flex flex-col bg-brand-light overflow-hidden fondo">
      <Head>
      ...
      <header className="min-w-full text-gray-800 py-14 px-4 md:px-0 items-center">
      ...
      <footer class="fixed bottom-0 left-0 z-20 p-4 w-full bg-transparent  md:flex md:items-center md:justify-between md:p-6 ">
        ...
        <ul class="flex flex-wrap items-center mt-3 text-sm text-black sm:mt-0 space-x-5 pr-10">
            <li>
            ...
            <li>
              <a
                  href="https://discord.com/invite/doodlintownomg"
                  target="_blank"
                  rel="noreferrer"
                >
                  <svg
